...
Begin VB.Form frmMPPromoCat 
   BorderStyle     =   0  'None
   Caption         =   "North Point MP Promo Rate"
   ClientHeight    =   7875
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   13680
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      EndProperty
      Picture         =   "frmMPPromoCat.frx":0000
      CaptionAlign    =   0
   End
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmMPPromoCat.frx":077A
      CaptionAlign    =   0
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmMPPromoCat.frx":0EF4
      CaptionAlign    =   0
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmMPPromoCat.frx":166E
      CaptionAlign    =   0
   End
   Begin xrControl.xrButton cmdButton 
      CausesValidation=   0   'False
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmMPPromoCat.frx":1DE8
      CaptionAlign    =   0
   End
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmMPPromoCat.frx":2562
   End
End
Attribute VB_Name = "frmMPPromoCat"
...
Private Sub chkTerm_Click(Index As Integer)
   ...
   Case 4
      oTrans.Master("n24months") = chkTerm(Index).Value
   End Select
End Sub
...
Private Sub Form_Load()
   ...
   oTrans.ProductType = "0" 'mobile phone
