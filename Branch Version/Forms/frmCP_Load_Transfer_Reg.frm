...
Begin VB.Form frmCP_Load_Transfer_Reg 
   BorderStyle     =   0  'None
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      EndProperty
      Picture         =   "frmCP_Load_Transfer_Reg.frx":0000
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   6
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_Load_Transfer_Reg.frx":077A
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   9
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_Load_Transfer_Reg.frx":0EF4
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   2
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_Load_Transfer_Reg.frx":166E
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   4
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_Load_Transfer_Reg.frx":1DE8
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   7
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_Load_Transfer_Reg.frx":2562
   End
   Begin xrGridEditor.GridEditor GridEditor1 
      ...
      GRIDLINESFIXED  =   2
      GRIDLINEWIDTH   =   1
      MOUSEICON       =   "frmCP_Load_Transfer_Reg.frx":2CDC
      MOUSEPOINTER    =   0
      REDRAW          =   -1  'True
      RIGHTTOLEFT     =   0   'False
      ROWS            =   2
   ...
   Begin xrControl.xrFrame xrFrame1 
      ...
      Begin VB.TextBox txtField 
         ...
         MultiLine       =   -1  'True
         TabIndex        =   13
         Text            =   "frmCP_Load_Transfer_Reg.frx":2CF8
         Top             =   1320
         Width           =   8460
      End
      Begin VB.TextBox txtField 
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_Load_Transfer_Reg.frx":2D0E
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   3
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_Load_Transfer_Reg.frx":3488
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   1
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_Load_Transfer_Reg.frx":3C02
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   5
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_Load_Transfer_Reg.frx":437C
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   10
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_Load_Transfer_Reg.frx":4AF6
   End
End
Attribute VB_Name = "frmCP_Load_Transfer_Reg"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Private Const pxeMODULENAME = "frmCP_Load_Transfer_Reg"

Private WithEvents oTrans As clsCPLoadTransfer
   ...
   With GridEditor1
      ...
      Case 0
         If .Rows > 2 Then
            pnCtr = 1
            Do While pnCtr <= .Rows
               If CDbl(.TextMatrix(pnCtr, 4)) = 0# And pnCtr <> 1 Then
                  .Row = pnCtr
            ...
            .ColWidth(2) = 4000
            If .Rows > 16 Then .ColWidth(2) = 3800
         End If
...
Private Sub Form_Load()
   ...
   Set oTrans = New clsCPLoadTransfer
...
Private Function PrintTrans() As Boolean
   ...
   With oTrans
      ...
      For lnCtr = 0 To .ItemCount - 1
         lrs.AddNew
         lrs.Fields("nField01") = oTrans.Detail(lnCtr, "nAmountxx")
