...
Begin VB.Form frmCP_Service_Center 
   BorderStyle     =   0  'None
   Caption         =   "CP Supplier Maintenance"
   ClientHeight    =   7395
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   7665
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_Service_Center.frx":0000
      PicturePos      =   1
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   705
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_Service_Center.frx":077A
      PicturePos      =   1
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   705
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_Service_Center.frx":0EF4
      PicturePos      =   1
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   705
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_Service_Center.frx":166E
      PicturePos      =   1
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   705
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_Service_Center.frx":1DE8
      PicturePos      =   1
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   705
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_Service_Center.frx":2562
      PicturePos      =   1
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   705
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_Service_Center.frx":2CDC
      PicturePos      =   1
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   705
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_Service_Center.frx":3456
      PicturePos      =   1
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   705
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_Service_Center.frx":3BD0
      PicturePos      =   1
   End
End
Attribute VB_Name = "frmCP_Service_Center"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Private Const pxeMODULENAME = "frmCP_Service_Center"
...
Private Sub oDriver_WillDelete(Cancel As Boolean)
   ...
   lsSQL = "DELETE FROM CP_Service_Center " _
            & "WHERE sClientID =" & strParm(oDriver.FieldValue(0))
   lnRow = oApp.Execute(lsSQL, "CP_Service_Center", oApp.BranchCode)
   If lnRow <= 0 Then
      MsgBox "Unable to Delete CP_Service_Center!!!", vbCritical, "Warning"
      Cancel = True
      GoTo endProc
   End If
...
Private Sub SearchCompany(Optional lsCompany As Variant)
   ...
   If lsBrowse <> "" Then
      ...
      If lrsSupplier("cRecdStat") = xeRecStateInactive Then
         MsgBox "CP Service Center Status is Deactivated!!!" & vbCrLf & _
                  "Please Save the record to activate!!!", vbInformation, "Notice"
         oDriver.RecordUpdate
...
loadSupplier:
   ...
   If lrsSupplier.State = adStateOpen Then
      For pnCtr = 0 To txtOthers.Count - 1
         If pnCtr < 5 Then
            oRS(pnCtr) = IIf(IsNull(lrsSupplier(pnCtr)), "", lrsSupplier(pnCtr))
...
Private Function UpdateCPSupplier() As Boolean
   Dim lsOldProc As String
   ...
   lsOldProc = "UpdateCPSupplier"
   ''On Error GoTo errProc
   
   Set lrs = New ADODB.Recordset
   lrs.Open "SELECT *" _
               & " FROM CP_Service_Center" _
               & " WHERE sClientID = " & strParm(oDriver.FieldValue(0)) _
   , oApp.Connection, adOpenStatic, adLockReadOnly, adCmdText
   
   If lrs.EOF Then
      lsSupplier = ADO2SQL(oRS, "CP_Service_Center", "", oApp.UserID, oApp.ServerDate, "sTermName")
   Else
      lsSupplier = ADO2SQL(oRS _
                                 , "CP_Service_Center" _
   ...
   If lsSupplier <> "" Then
      lnRow = oApp.Execute(lsSupplier, "CP_Service_Center", oApp.BranchCode)
      If lnRow <= 0 Then
         MsgBox "Unable to Update CP Service Center Master Table!!!" & vbCrLf & _
                  "Please Contact GMCSEG/GGCSEG for assistance!!!", vbCritical, "Warning"
         GoTo endProc
      End If
   End If
   
   UpdateCPSupplier = True

endProc:
   Set lrs = Nothing
   Exit Function
errProc:
   ShowError lsOldProc & "( " & UpdateCPSupplier & " )", True
End Function
