...
Begin VB.Form frmCP_PO_Return 
   ...
   Begin xrGridEditor.GridEditor GridEditor1 
      ...
      GRIDLINESFIXED  =   2
      GRIDLINEWIDTH   =   1
      MOUSEICON       =   "frmCP_PO_Return.frx":0000
      MOUSEPOINTER    =   0
      REDRAW          =   -1  'True
      RIGHTTOLEFT     =   0   'False
      ROWS            =   2
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_PO_Return.frx":001C
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   0
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_PO_Return.frx":0796
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   1
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_PO_Return.frx":0F10
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   3
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_PO_Return.frx":168A
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   4
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_PO_Return.frx":1E04
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   6
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_PO_Return.frx":257E
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   5
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_PO_Return.frx":2CF8
   End
   ...
   End
End
Attribute VB_Name = "frmCP_PO_Return"
...
Private Sub GridEditor1_EditorValidate(Cancel As Boolean)
   ...
   With GridEditor1
      ...
      If oTrans.Detail(.Row - 1, "cHsSerial") = xeYes Then
         Select Case .Col
         Case 1, 2
            If .TextMatrix(.Row, .Col) <> "" And .TextMatrix(.Row, .Col) <> 0# Then
               If .Row = .Rows - 1 Then
                  .Rows = .Rows + 1
                  oTrans.addDetail
                  .Col = 0
   ...
   If KeyCode = vbKeyF3 Then
      With GridEditor1
         ...
         If oTrans.searchDetail(.Row - 1, .Col, .TextMatrix(.Row, .Col)) Then
            If oTrans.Detail(.Row - 1, "cHsSerial") = xeYes And oTrans.Detail(.Row - 1, "nUnitPrce") <> 0# Then
               If .Row = .Rows - 1 Then
                  .Rows = .Rows + 1
                  oTrans.addDetail
               End If
...
Private Function isEntryOk() As Boolean
   ...
   ' remove this validation beacuse jefanny allow return from different reference
