...
Begin VB.Form frmCPLoadAdj 
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCPLoadAdj.frx":2562
   End
End
Attribute VB_Name = "frmCPLoadAdj"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Private Const pxeMODULENAME = "frmCPLoadAdj"
...
Private Sub oTrans_MasterRetrieved(ByVal Index As Variant)
   Select Case Index
   Case 9
      txtField(Index) = Format(IFNull(oTrans.Master(Index), 0#), "#,##0.00")
   Case 7, 8, 10, 11, 13
