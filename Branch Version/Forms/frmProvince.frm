...
Option Explicit
Private Const pxeMODULENAME = "frmProvince"
...
Private Sub Form_Load()
   ...
   oDriver.BrowseFTitle(1) = "Province"
...
Private Sub oDriver_InitValue()
   ...
   If oDriver.SetValue(0, GetNextCode("Province", "sProvIDxx", False, oApp.Connection)) = False Then Exit Sub
