...
Begin VB.Form frmCP_Price_ProtectionPosting 
   BorderStyle     =   0  'None
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_Price_ProtectionPosting.frx":0000
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   0
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_Price_ProtectionPosting.frx":077A
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   1
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_Price_ProtectionPosting.frx":0EF4
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   5
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_Price_ProtectionPosting.frx":166E
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   6
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_Price_ProtectionPosting.frx":1DE8
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   3
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_Price_ProtectionPosting.frx":2562
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   4
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_Price_ProtectionPosting.frx":2CDC
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   7
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_Price_ProtectionPosting.frx":3456
   End
End
Attribute VB_Name = "frmCP_Price_ProtectionPosting"
...
Private Const pxeMODULENAME = "frmCP_Price_ProtectionPosting"
...
Private Sub cmdButton_Click(Index As Integer)
   ...
   Case 0 'Browse
      ...
      End If
   Case 1 'Confirm
      If txtField(2).Text <> "" And (oTrans.Master("cTranStat") <> xeStateCancelled Or oTrans.Master("cTranStat") <> xeStatePosted) Then
...
Private Sub ComputeTotal()
   ...
   With MSFlexGrid1
      For lnCtr = 0 To oTrans.ItemCount - 1
         lnDiff = lnDiff + (.TextMatrix(lnCtr + 1, 3) - .TextMatrix(lnCtr + 1, 2))
      Next
      Call LoadSerial
   End With

   lnGrandTotl = Format(lnDiff * p_oserial.RecordCount, "#,##0.00")
   ...
   If oPO.Master("sTransNox") <> "" Then
        ...
        Set xlsheet = xlwbook.Sheets.Item(1)
         ...
         lsSQL = "SELECT" & _
               ...
               ", CP_Price_Protection_Master e" & _
               ", CP_Model d" & _
               " WHERE a.sSerialID = b.sSerialId" & _
               " AND c.sTransNox = e.sTransNox" & _
               " AND b.sTransNox = c.sTransNox" & _
               " AND c.sModelIDx = d.sModelIDx" & _
               " AND b.sTransNox = " & strParm(oPO.Master("sTransNox"))
         Debug.Print lsSQL
