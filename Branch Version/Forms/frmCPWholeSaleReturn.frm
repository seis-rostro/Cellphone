...
Begin VB.Form frmCPWholeSaleReturn 
   Appearance      =   0  'Flat
   BackColor       =   &H80000005&
   BorderStyle     =   0  'None
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCPWholeSaleReturn.frx":0000
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   0
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCPWholeSaleReturn.frx":077A
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   1
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCPWholeSaleReturn.frx":0EF4
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   3
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCPWholeSaleReturn.frx":166E
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   4
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCPWholeSaleReturn.frx":1DE8
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   6
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCPWholeSaleReturn.frx":2562
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   5
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCPWholeSaleReturn.frx":2CDC
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   7
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCPWholeSaleReturn.frx":3456
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   8
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCPWholeSaleReturn.frx":3B50
   End
End
Attribute VB_Name = "frmCPWholeSaleReturn"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Private Const pxeMODULENAME = "frmCPWholeSaleReturn"
...
Private Sub cmdButton_Click(Index As Integer)
   ...
   With MSFlexGrid1
      ...
      Case 0 'save
         If .Rows > 2 Then
           If Trim(oTrans.Detail(oTrans.ItemCount - 1, "sStockIDx")) = "" Then
               If oTrans.deleteDetail(.Row - 1) Then LoadDetail
            End If
         End If
   
         If isEntryOk Then
            oTrans.Master(6) = CDbl(lblNetTotal.Caption) 'nTranTotl
      ...
      Case 6 'close
         Unload Me
      Case 7 'registers
         frmCPWholeSaleReturnReg.Tag = Me.Tag
         frmCPWholeSaleReturnReg.Show
      End Select
   End With
endProc:
   Exit Sub
...
Private Sub InitForm()
   ...
   txtField(5).MaxLength = oTrans.MasFldSize(5)
End Sub
...
Private Sub txtOthers_LostFocus(Index As Integer)
   With MSFlexGrid1
      If Index = 3 Then
         If Not IsNumeric(txtOthers(Index)) Then txtOthers(Index) = 0
...
Private Sub LoadDetail()
   ...
   With MSFlexGrid1
      ...
      For lnCtr = 0 To oTrans.ItemCount - 1
         ...
         .TextMatrix(lnCtr + 1, 5) = IFNull(oTrans.Detail(lnCtr, "nQtyOnHnd"), 0)
         .TextMatrix(lnCtr + 1, 6) = Format(oTrans.Detail(lnCtr, "nUnitPrce"), "#,##0.00")
         .TextMatrix(lnCtr + 1, 7) = IFNull(oTrans.Detail(lnCtr, "nQuantity"), 0)
