...
Begin VB.Form frmDASerialNew 
   ...
   Begin xrGridEditor.GridEditor GridEditor1 
      ...
      GRIDLINESFIXED  =   2
      GRIDLINEWIDTH   =   1
      MOUSEICON       =   "frmDASerialNew.frx":0000
      MOUSEPOINTER    =   0
      REDRAW          =   -1  'True
      RIGHTTOLEFT     =   0   'False
      ROWS            =   2
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmDASerialNew.frx":001C
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   0
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmDASerialNew.frx":0796
   End
End
Attribute VB_Name = "frmDASerialNew"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Private Const pxeMODULENAME = "frmDASerialNew"
...
Dim pnEditMode As xeEditMode

Property Let EntryNo(bEntry As Boolean)
   pbEntryNo = bEntry
End Property

Property Let EditMode(nEditMode As xeEditMode)
   pnEditMode = nEditMode
End Property
            ...
            If pnEditMode = xeModeAddNew Then
               ...
               lrs.Open "SELECT" & _
                        ...
                        " FROM CP_Inventory_Serial a" & _
                           " LEFT JOIN CP_PO_Receiving_Serial b" & _
                              " LEFT JOIN CP_PO_Receiving_Master c" & _
                                 " LEFT JOIN Branch d" & _
                                    " ON LEFT(c.sTransNox, " & Len(oApp.BranchCode) & ") = d.sBranchCd" & _
                                 " LEFT JOIN Client_Master e" & _
                                    " ON c.sSupplier = e.sClientID" & _
                                 " ON b.sTransNox = c.sTransNox" & _
                              " ON a.sSerialID = b.sSerialID" & _
                        " WHERE a.sSerialNo = " & strParm(.TextMatrix(pnCtr, IIf(pbEntryNo, 2, 1))) _
               , oApp.Connection, adOpenForwardOnly, adLockReadOnly, adCmdText
               
               If Not lrs.EOF Then
                  MsgBox "DUPLICATE ENTRY" & vbCrLf & _
                           "IMEI NO: " & lrs("sSerialNo") & vbCrLf & _
                           "COMPANY: " & lrs("sCompnyNm") & vbCrLf & _
                           "REFER NO: " & lrs("sReferNox") & vbCrLf & _
                           "REFER DATE: " & Format(lrs("dReferDte"), "MMM-DD,YYYY") & vbCrLf & _
                           "RECEIVED BY: " & Format(lrs("sBranchNm"), "MMM-DD,YYYY")
                  .Row = pnCtr
                  Exit Sub
               End If
               Set lrs = Nothing
