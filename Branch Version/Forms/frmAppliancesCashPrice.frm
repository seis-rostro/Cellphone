...
Begin VB.Form frmAppliancesCashPrice 
   BackColor       =   &H8000000C&
   BorderStyle     =   0  'None
   ...
   Begin xrControl.xrFrame xrFrame2 
      ...
      Begin VB.ComboBox cmbSearch 
         ...
         EndProperty
         Height          =   360
         ItemData        =   "frmAppliancesCashPrice.frx":0000
         Left            =   90
         List            =   "frmAppliancesCashPrice.frx":0002
         TabIndex        =   2
         Top             =   90
         Width           =   2400
      End
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmAppliancesCashPrice.frx":0004
   End
End
Attribute VB_Name = "frmAppliancesCashPrice"
...
Private Sub cmbSearch_Click()
   ...
   With MSFlexGrid1
      If cmbSearch.ListIndex = 0 Then 'Category
         .Col = 1
         lnSearch = 1
...
Private Sub InitForm()
   ...
   With MSFlexGrid1
      ...
      .TextMatrix(0, 3) = "Model Name"
      .TextMatrix(0, 4) = "Model Code"
      .TextMatrix(0, 5) = "Selling Price"
      .TextMatrix(0, 6) = "Last Price"
...
'      .TextMatrix(0, 7) = "SRP 4"
      ...
      'Column Width
      .ColWidth(0) = 450
      .ColWidth(1) = 1600 'Category
      .ColWidth(2) = 1600 'Brand
      .ColWidth(3) = 3950 'Model
      .ColWidth(4) = 3950 'Model code
      .ColWidth(5) = 1250
      .ColWidth(6) = 1250
'      .ColWidth(6) = 0
'      .ColWidth(7) = 0
...
Private Sub LoadPrice()
   ...
   Dim lasFormat(7) As String

   lasFormat(0) = "@"
   lasFormat(1) = "@" 'category
   lasFormat(2) = "@" 'Brand
   lasFormat(3) = "@" 'Model name
   lasFormat(4) = "@" 'model code
   lasFormat(5) = "#,##0.00"
   lasFormat(6) = "#,##0.00"
   lasFormat(7) = "#,##0.00"
'   lasFormat(6) = "#,##0.00"
...
'   lasFormat(8) = "#,##0.00"
   ...
   With oPriceList
      ...
      Do While lnCtr < .CashPriceCount
         ...
         For lnCol = 1 To MSFlexGrid1.Cols - 1
            MSFlexGrid1.Col = lnCol
            MSFlexGrid1.TextMatrix(lnRow, 1) = Format(IFNull(.CashPrice(lnCtr, 7), 0), lasFormat(7))
            MSFlexGrid1.TextMatrix(lnRow, 2) = Format(IFNull(.CashPrice(lnCtr, 3), 0), lasFormat(3))
            MSFlexGrid1.TextMatrix(lnRow, 3) = Format(IFNull(.CashPrice(lnCtr, 1), 0), lasFormat(1))
            MSFlexGrid1.TextMatrix(lnRow, 4) = Format(IFNull(.CashPrice(lnCtr, 2), 0), lasFormat(2))
            MSFlexGrid1.TextMatrix(lnRow, 5) = Format(IFNull(.CashPrice(lnCtr, 4), 0), "#,##0.00")
            MSFlexGrid1.TextMatrix(lnRow, 6) = Format(IFNull(.CashPrice(lnCtr, 5), 0), "#,##0.00")
