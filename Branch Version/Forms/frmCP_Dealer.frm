...
Begin VB.Form frmCP_Dealer 
   BorderStyle     =   0  'None
   Caption         =   "Dealer Maintenance"
   ClientHeight    =   3195
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   5535
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_Dealer.frx":2CDC
      PicturePos      =   1
   End
End
Attribute VB_Name = "frmCP_Dealer"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Private Const pxeMODULENAME = "frmCP_Dealer"
...
Private Sub oDriver_InitValue()
   ...
   If Not oDriver.SetValue(0, GetNextCode("CP_Dealer", "sDealerID", False, oApp.Connection, True, oApp.BranchCode)) Then Exit Sub
