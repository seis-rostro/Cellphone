...
Begin VB.Form frmCPOrderHistory 
   BorderStyle     =   0  'None
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      EndProperty
      Picture         =   "frmCPOrderHistory.frx":0000
   End
   ...
   End
End
Attribute VB_Name = "frmCPOrderHistory"
...
Private Sub loadHistory()
   ...
   txtField(1) = p_sDescript
   
   For lnCtr = 0 To UBound(p_vHistory)
