...
Begin VB.Form frmCPDeliveryOthers 
   BorderStyle     =   0  'None
   Caption         =   "Delivery (Others)"
   ClientHeight    =   9315
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   15255
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      EndProperty
      Picture         =   "frmCPDeliveryOthers.frx":0000
   End
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCPDeliveryOthers.frx":077A
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   0
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCPDeliveryOthers.frx":0EF4
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   1
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCPDeliveryOthers.frx":166E
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   4
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCPDeliveryOthers.frx":1DE8
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   5
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCPDeliveryOthers.frx":2562
   End
End
Attribute VB_Name = "frmCPDeliveryOthers"
...
Private Sub cmdButton_Click(Index As Integer)
   ...
   Select Case Index
      Case 0 'OK/save
         With oTrans
            If .Detail(.ItemCount, "sbarrcode") = "" Then
               .deleteDetail (.ItemCount - 1)
               MSFlexGrid1.Rows = MSFlexGrid1.Rows - 1
            End If
               
               If MSFlexGrid1.TextMatrix(1, 3) <> 0 Then
                  If isEntryOk Then
                  ...
                  End If
               Else
                  MsgBox "No Quantity Detected!" & vbCrLf & _
                        "Pls verify your entry then try again.", vbInformation
               End If
         End With
      Case 1 'del
         Call deleteDetail
   ...
   With MSFlexGrid1
      Select Case Index
         ...
         Case 6
            ...
            txtOthers(Index) = oTrans.Detail(.Row - 1, "nquantity")
      End Select
   End With
End Sub
...
Private Sub LoadStockRequest()
   ...
   With MSFlexGrid2
      ...
      For lnCtr = 0 To lnRow - 1
         ...
         poRS("sDescript") = oTrans.StockDetail(lnCtr, "sDescript")
      ...
      Do Until poRS.EOF
         ...
         .TextMatrix(lnCtr, 1) = poRS("sBarrCode")
         .TextMatrix(lnCtr, 2) = poRS("sDescript")
         .TextMatrix(lnCtr, 3) = poRS("nQtyOnHnd")
      ...
      Select Case Index
         Case 1
            Select Case KeyCode
               ...
               Case vbKeyReturn
                  If oTrans.searchDetail(.Row - 1, IIf(Index = 1, "xReferNox", "sDescript"), txtOthers(1)) Then
                     If oTrans.Detail(.Row - 1, "nquantity") > 0 Then
                        If .Row = .Rows - 1 Then
                           Call addDetail
                        Else
                           .Row = .Row + 1
                        ...
                        End If
                     Else
                        txtOthers(6).SetFocus
                     End If
                  End If
            End Select
         Case 6
            If KeyCode = vbKeyReturn Then
               If Not IsNumeric(txtOthers(6)) Then
                  txtOthers(6).Text = 0
               End If
               
               oTrans.Detail(.Row - 1, "nquantity") = txtOthers(6)
               If .Row = .Rows - 1 _
                  And oTrans.Detail(.Row - 1, "nquantity") > 0 _
                  And oTrans.Detail(.Row - 1, 0) <> "" Then
...
'               poRS("nIssuedxx") = poRS("nIssuedxx") + 1
               poRS("nIssuedxx") = oTrans.Detail(.Row - 1, "nquantity")
               With MSFlexGrid2
      ...
      If oTrans.addDetail Then
         ...
         oTrans.Detail(.Row - 1, "nquantity") = 0
         If .Rows > 16 Then
            .ColWidth(1) = 3720
            .ColWidth(2) = 8500
            .TopRow = .Rows - 14
...
Private Sub setDetailInfo()
   ...
   With oTrans
      ...
      txtOthers(2) = oTrans.Detail(lnRow - 1, "sbrandnme")
      txtOthers(6) = oTrans.Detail(lnRow - 1, "nquantity")
   End With
End Sub
...
Private Sub deleteDetail()
   ...
   With MSFlexGrid1
      ...
      If Not poRS.EOF Then lnQty = poRS("nIssuedxx")
      
      If oTrans.deleteDetail(.Row - 1) Then
         lnRow = oTrans.ItemCount

         If Not poRS.EOF Then
            poRS("nIssuedxx") = poRS("nIssuedxx") - lnQty
...
NopoRS:
         ...
         For lnCtr = 0 To lnRow - 1
            ...
            .TextMatrix(lnCtr + 1, 1) = IFNull(oTrans.Detail(lnCtr, "xReferNox"))
            .TextMatrix(lnCtr + 1, 2) = IFNull(oTrans.Detail(lnCtr, "sBrandNme"))
            .TextMatrix(lnCtr + 1, 3) = IFNull(oTrans.Detail(lnCtr, "nQuantity"))
         Next
...
Private Function PrintTrans() As Boolean
   ...
   lrs.Fields.Append "nField03", adCurrency
   ...
   With oTrans
      ...
      For lnCtr = 0 To .ItemCount - 1
         ...
         lrs.Fields("sField05") = oTrans.Detail(lnCtr, "sBrandNme") & "-" & oTrans.Detail(lnCtr, "sModelNme")
         lrs.Fields("nField03") = oTrans.Detail(lnCtr, "nUnitPrce")
...
Private Function isEntryOk() As Boolean
   ...
   With MSFlexGrid1
      pnCtr = 1
      Do While pnCtr < .Rows
         If .TextMatrix(pnCtr, 3) = 0 Then
            MsgBox "No Quantity to transfer!!!" & vbCrLf & _
   ...
   If oTrans.Master("sBranchNm") = "" Or txtField(2).Text = "" Then
      MsgBox "Invalid Destination Branch!!!" & vbCrLf & _
               "Please Verify your entry then try again!!!", vbCritical, "Warning"
      txtField(2).SetFocus
      GoTo EntryNotOK
   End If
...
Private Function PrintOrders() As Boolean
   ...
   lsSQL = "SELECT g.sBranchNm" & _
            ...
            " AND a.sTransNox = " & strParm(oTrans.StockReqSourceNo)
   ...
   With poPrinter
      ...
      Do Until lors.EOF
         If pnPrintRow = pxeMaxLine Then
            ...
            .PrintText 1, 2, lsLineStr
            pnPrintRow = 2
         End If

         lsLineStr = padRight(Trim(lors("sBrandNme")), 15) & " " & _
                        padRight(Trim(lors("sModelNme")), 20) & " " & _
                        padRight(Trim(lors("sColorNme")), 20) & " " & _
                        padRight(Trim(lors("nQtyOnHnd")), 7) & _
                        padRight(Format(lors("nQuantity"), "#0"), 7)
