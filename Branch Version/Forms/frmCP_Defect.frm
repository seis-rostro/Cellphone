...
Begin VB.Form frmCP_Defect 
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_Defect.frx":3456
      PicturePos      =   1
   End
End
Attribute VB_Name = "frmCP_Defect"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Private Const pxeMODULENAME = "frmCP_Defect"
...
Private Sub oDriver_InitValue()
   ...
   If oDriver.SetValue(0, GetNextCode("CP_Defect", "sDefectID", False, oApp.Connection, True, oApp.BranchCode)) = False Then Exit Sub
