...
Private Sub Form_Load()
   ...
   oDriver.BrowseFTitle(1) = "Country"
   oDriver.BrowseFTitle(2) = "Nationality"
...
Private Sub oDriver_InitValue()
   ...
   If oDriver.SetValue(0, GetNextCode("Country", "sCntryCde", False, oApp.Connection)) = False Then Exit Sub
