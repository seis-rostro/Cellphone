...
Option Explicit
Private Const pxeMODULENAME = "frmSection"
...
Private Sub oDriver_InitValue()
   ...
   If Not oDriver.SetValue(0, GetNextCode("Section", "sSectnIDx", False, oApp.Connection, False, "")) Then Exit Sub
