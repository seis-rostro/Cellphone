...
Private WithEvents oTrans As ggcCPSales.clsCPLoad
...
'      If Not isEntryOK Then Exit Sub
      ...
      If oTrans.NewTransaction Then
         ...
         txtField(1).SetFocus
      Else
         MsgBox "Unable to Initialized Transaction..." & vbCrLf & _
                  "Please contact SEG/SSG for assistance...", vbCritical, "WARNING"
      End If
   Case vbKeyEscape
      Unload Me
   End Select
...
Private Sub Form_Load()
   ...
   Set oTrans = New ggcCPSales.clsCPLoad
