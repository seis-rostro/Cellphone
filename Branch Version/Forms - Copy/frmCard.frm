...
Option Explicit
Private Const pxeMODULENAME = "frmCard"
...
Private Sub Form_Load()
   ...
   oDriver.RecQuery = "SELECT * FROM Card"
   ...
   oDriver.BrowseFTitle(1) = "Card Name"
...
Private Sub oDriver_InitValue()
   ...
   If oDriver.SetValue(0, GetNextCode("Card", "sCardIDxx", False, oApp.Connection, True, oApp.BranchCode)) = False Then Exit Sub
