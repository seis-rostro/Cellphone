...
Option Explicit
Private Const pxeMODULENAME = "frmBin"
...
Private Sub oDriver_InitValue()
   ...
   If Not oDriver.SetValue(0, GetNextCode("Bin", "sLevelIDx", False, oApp.Connection, True, oApp.BranchCode)) Then Exit Sub
