...
Begin VB.Form frmCPTradeInTransferReg 
   BorderStyle     =   0  'None
   Caption         =   "CP Trade In Transfer History"
   ClientHeight    =   7110
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   12840
   ...
   Begin xrControl.xrFrame xrFrame 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.TextBox txtField 
            ...
            MultiLine       =   -1  'True
            TabIndex        =   1
            Text            =   "frmCPTradeInTransferReg.frx":0000
            Top             =   2040
            Width           =   2265
         End
         Begin VB.Label Label10 
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCPTradeInTransferReg.frx":0006
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   3
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCPTradeInTransferReg.frx":0780
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   5
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCPTradeInTransferReg.frx":0EFA
   End
End
Attribute VB_Name = "frmCPTradeInTransferReg"
...
'Option Explicit
'
'Private Const pxeMODULENAME = "frmCPTradeInTransferReg"
...
'Private pbLoadRecord As Boolean
'
...
'             End If
'         Case 8 'Print
'         If pbLoadRecord = True Then
'            If MsgBox("Do you want to create a printable document " & vbCrLf & _
...
'      Next
'   End With
'   txtField(80).Text = Format(oTrans.Master("sTransNox"), "@@@@-@@-@@@@@@")
'   txtField(81).Text = oTrans.Master(2)
'   pbLoadRecord = True
'End Sub
'
...
'                        If oTrans.SearchTransaction(txtField(Index).Text, True) = True Then
'                           LoadMaster
'                           LoadDetail
'                           showdetail
...
'               Case 81
'                  If KeyCode = vbKeyF3 Or KeyCode = vbKeyReturn Then
'                     If oTrans.SearchTransaction(txtField(Index).Text, False) = True Then
'                        LoadMaster
'                        LoadDetail
'                        showdetail
'                        If txtField(Index).Text <> "" Then SetNextFocus
