...
Private Sub GridEditor1_EditorValidate(Cancel As Boolean)
   ...
   With GridEditor1
      ...
      If .Col = 5 Then
         oTrans.Detail(.Row - 1, "nQuantity") = .TextMatrix(.Row, 5)
      ElseIf .Col = 6 Then
         oTrans.Detail(.Row - 1, "nUnitPrce") = .TextMatrix(.Row, 6)
      Else
      ...
      If .Rows > 16 Then
         ...
         .ColWidth(3) = 2100
      End If
      Debug.Print oTrans.Detail(.Row - 1, "nQuantity")
   End With
   pbGridValidate = True
endProc:
'   GridEditor1.Refresh
...
Public Function PrintTrans() As Boolean
   ...
   With oReport
    ...
    .Sections("PH").ReportObjects("txtTerm").SetText txtField(12)
    ...
    .Sections("PF").ReportObjects("txtRequested").SetText oApp.UserName
   If oApp.BranchCode = "M0W1" Or oApp.BranchCode = "M001" Then
      .Sections("PF").ReportObjects("txtApproved").SetText "Arnold Guillen"
   Else
      .Sections("PF").ReportObjects("txtApproved").SetText "Mylene Lo"
   End If
