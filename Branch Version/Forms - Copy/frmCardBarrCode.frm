...
Begin VB.Form frmCardBarrCode 
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCardBarrCode.frx":0000
      CaptionAlign    =   0
   End
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCardBarrCode.frx":077A
      CaptionAlign    =   0
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   405
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCardBarrCode.frx":0EF4
      CaptionAlign    =   0
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   405
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCardBarrCode.frx":166E
      CaptionAlign    =   0
   End
End
Attribute VB_Name = "frmCardBarrCode"
...
Private Sub SearchBarCode(ByVal SearchValue As Boolean)
   ...
   lrs.Open lsSQL, oApp.Connection, adOpenStatic, adLockReadOnly, adCmdText
      ...
      If lrs.RecordCount = 1 Then
         ...
         txtField(1).Text = Trim(IIf(IsNull(lrs("sBrandNme")), "", lrs("sBrandNme")) _
...
Private Sub DisplayReport()
   ...
   Set oReport = oRepApp.OpenReport(oApp.AppPath & "\Reports\CP_BarrCode.rpt")
