...
Begin VB.Form frmPostCPDelivery 
   BorderStyle     =   0  'None
   Caption         =   "Delivery Posting"
   ClientHeight    =   6960
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   11415
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      EndProperty
      Picture         =   "frmPostCPDelivery.frx":0000
   End
   Begin xrGridEditor.GridEditor GridEditor1 
      ...
      GRIDLINESFIXED  =   2
      GRIDLINEWIDTH   =   1
      MOUSEICON       =   "frmPostCPDelivery.frx":077A
      MOUSEPOINTER    =   0
      REDRAW          =   -1  'True
      RIGHTTOLEFT     =   0   'False
      ROWS            =   2
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmPostCPDelivery.frx":0796
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   1
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmPostCPDelivery.frx":0F10
   End
   Begin xrControl.xrFrame xrFrame1 
      Height          =   525
      Index           =   1
   ...
   End
End
Attribute VB_Name = "frmPostCPDelivery"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Private Const pxeMODULENAME = "frmPostCPDelivery"
...
Private Sub LoadDetail()
   ...
   With GridEditor1
      ...
      For pnCtr = 0 To oTrans.ItemCount - 1
         ...
         Next
         .TextMatrix(pnCtr + 1, 5) = oTrans.Detail(pnCtr, "nQtyOnHnd")
