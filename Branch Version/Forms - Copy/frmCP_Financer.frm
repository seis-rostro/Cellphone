...
Begin VB.Form frmCP_Financer 
   BorderStyle     =   0  'None
   Caption         =   "CP Financer Maintenance"
   ClientHeight    =   7650
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   7665
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_Financer.frx":0000
      PicturePos      =   1
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   705
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_Financer.frx":077A
      PicturePos      =   1
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   705
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_Financer.frx":0EF4
      PicturePos      =   1
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   705
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_Financer.frx":166E
      PicturePos      =   1
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   705
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_Financer.frx":1DE8
      PicturePos      =   1
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   705
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_Financer.frx":2562
      PicturePos      =   1
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   705
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_Financer.frx":2CDC
      PicturePos      =   1
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   705
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_Financer.frx":3456
      PicturePos      =   1
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   705
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_Financer.frx":3BD0
      PicturePos      =   1
   End
End
Attribute VB_Name = "frmCP_Financer"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Private Const pxeMODULENAME = "frmFinancer"
...
Private Sub Check1_Click()
   oRS("cInHousex") = IIf(Check1.Value = Checked, 1, 0)
End Sub
...
Private Sub cmdButton_Click(Index As Integer)
   ...
   Case 7
      ...
      End If
   Case 8
'      If Not pbNewFinancer Then
'         oForm.ClientID = oDriver.FieldValue(0)
'         oForm.Caption = "MC Financer Ledger"
'         oForm.Show 1
'      Else
'         MsgBox "Unable to Load Financer Ledger!!!" & vbCrLf & _
...
Private Sub Form_Load()
   ...
   psFinancer = "SELECT" _
                  ...
                  & " FROM CP_Financer a" _
                     & " LEFT JOIN Term b" _
                        & " ON a.sTermIDxx = b.sTermIDxx"
   
   Set oRS = New ADODB.Recordset
   lsSQL = AddCondition(psFinancer, "0 = 1")
...
Private Sub oDriver_LoadOtherData()
   ...
   Set oRS = New ADODB.Recordset
   lsSQL = AddCondition(psFinancer, "a.sClientID = " & strParm(oDriver.FieldValue(0)) _
   ...
   Check1.Value = IIf(oRS("cInHousex") = 1, Checked, Unchecked)
   pbLoadOthers = True
   pbLoading = True
...
Private Sub oDriver_WillDelete(Cancel As Boolean)
   ...
   lsSQL = "DELETE FROM CP_Financer " _
            & "WHERE sClientID =" & strParm(oDriver.FieldValue(0))
   lnRow = oApp.Execute(lsSQL, "CP_Financer", oApp.BranchCode)
   If lnRow <= 0 Then
      MsgBox "Unable to Delete CP Financer!!!", vbCritical, "Warning"
      Cancel = True
      GoTo endProc
   End If
...
Private Sub SearchCompany(Optional lsCompany As Variant)
   ...
   Dim lsSQL As String
   Dim lsOldProc As String
   Dim lrsFinancer As ADODB.Recordset
   Dim lsSelected() As String
   ...
   Set lrs = New ADODB.Recordset
   Set lrsFinancer = New ADODB.Recordset
   ...
   If lsBrowse <> "" Then
      ...
      lsSQL = AddCondition(psFinancer, "a.sClientID = " & strParm(lrs("sClientID")))
      lrsFinancer.Open lsSQL, oApp.Connection, adOpenStatic, adLockReadOnly, adCmdText
      If lrsFinancer.EOF Then
         MsgBox "Financer not yet added to your branch!!!" & vbCrLf & _
      ...
      lrsFinancer.Find "sBranchCd = " & strParm(oApp.BranchCode), 0, adSearchForward
      If lrsFinancer.EOF Then
         lrsFinancer.MoveFirst
         MsgBox "Financer not yet added to your branch!!!" & vbCrLf & _
               "Please Save the record to activate!!!", vbInformation, "Notice"
         GoTo loadFinancer
      Else
         If lrsFinancer("cRecdStat") = xeRecStateInactive Then
            MsgBox "MC Financer Status is Deactivated!!!" & vbCrLf & _
                     "Please Save the record to activate!!!", vbInformation, "Notice"
            oDriver.RecordUpdate
...
loadFinancer:
   InitOthers
   txtField(pnIndex).Tag = txtField(pnIndex).Text
   If lrsFinancer.State = adStateOpen Then
      For pnCtr = 0 To txtOthers.Count - 1
         If pnCtr < 5 Then
            oRS(pnCtr) = IIf(IsNull(lrsFinancer(pnCtr)), "", lrsFinancer(pnCtr))
            txtOthers(pnCtr).Text = oRS(pnCtr)
         End If
      Next
      oRS("sClientID") = lrsFinancer("sClientID")
      oRS("sTermIDxx") = IIf(IsNull(lrsFinancer("sTermIDxx")), "", lrsFinancer("sTermIDxx"))
   End If
   GoTo endProc
endProc:
   Set lrs = Nothing
   Set lrsFinancer = Nothing
   Exit Sub
errProc:
...
Private Function UpdateCPFinancer() As Boolean
   Dim lsOldProc As String
   ...
   If lrs.EOF Then
      lsFinancer = ADO2SQL(oRS, "CP_Financer", "", oApp.UserID, oApp.ServerDate, "sTermName")
   Else
      lsFinancer = ADO2SQL(oRS _
                                 , "CP_Financer" _
                                 , "sClientID = " & strParm(oDriver.FieldValue(0)) _
                                 , oApp.UserID, oApp.ServerDate, "sTermName")
   End If
   
   If lsFinancer <> "" Then
      lnRow = oApp.Execute(lsFinancer, "CP_Financer", oApp.BranchCode)
      If lnRow <= 0 Then
         MsgBox "Unable to Update CP Financer Master Table!!!" & vbCrLf & _
                  "Please Contact GMCSEG/GGCSEG for assistance!!!", vbCritical, "Warning"
         GoTo endProc
      End If
   End If
   
   UpdateCPFinancer = True

endProc:
   Set lrs = Nothing
   Exit Function
errProc:
   ShowError lsOldProc & "( " & UpdateCPFinancer & " )", True
End Function
