...
Option Explicit
Private Const pxeMODULENAME = "frmColor"
...
Private Sub oDriver_InitValue()
   ...
   If oDriver.SetValue(0, GetNextCode("Color", "sColorIDx", False, oApp.Connection, True, oApp.BranchCode)) = False Then Exit Sub
