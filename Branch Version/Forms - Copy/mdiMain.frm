...
Private Sub mnuCashAdvReg_Click(Index As Integer)
   frmCashAdvanceReg.Tag = "mnuCashAdvReg"
   frmCashAdvanceReg.Show
End Sub
...
Private Sub mnuInventoryCount_Click()
'   frmCPInvCount.Tag = "mnuInventoryCount"
'   frmCPInvCount.CountLevel = 1
'   frmCPInvCount.Show
End Sub
