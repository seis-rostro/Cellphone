...
Begin VB.Form frmCP_PO_Return_Reg 
   BorderStyle     =   0  'None
   Caption         =   "PO Return"
   ClientHeight    =   6900
   ClientLeft      =   0
   ...
   Begin xrGridEditor.GridEditor GridEditor1 
      ...
      GRIDLINESFIXED  =   2
      GRIDLINEWIDTH   =   1
      MOUSEICON       =   "frmCP_PO_Return_Reg.frx":0000
      MOUSEPOINTER    =   0
      REDRAW          =   -1  'True
      RIGHTTOLEFT     =   0   'False
      ROWS            =   2
   ...
   Begin xrControl.xrFrame xrFrame1 
      ...
      Begin VB.TextBox txtField 
         ...
         MultiLine       =   -1  'True
         TabIndex        =   15
         Text            =   "frmCP_PO_Return_Reg.frx":001C
         Top             =   1575
         Width           =   4545
      End
      Begin VB.TextBox txtField 
      ...
      Begin VB.TextBox txtField 
         ...
         MultiLine       =   -1  'True
         TabIndex        =   9
         Text            =   "frmCP_PO_Return_Reg.frx":0024
         Top             =   1095
         Width           =   4545
      End
      Begin VB.TextBox txtField 
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_PO_Return_Reg.frx":0033
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   5
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_PO_Return_Reg.frx":07AD
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   2
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_PO_Return_Reg.frx":0F27
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   1
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_PO_Return_Reg.frx":16A1
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   0
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_PO_Return_Reg.frx":1E1B
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   6
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_PO_Return_Reg.frx":2595
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   4
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_PO_Return_Reg.frx":2D0F
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   7
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_PO_Return_Reg.frx":3489
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   8
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_PO_Return_Reg.frx":3C03
   End
   Begin xrControl.xrFrame xrFrame1 
      Height          =   525
      Index           =   1
   ...
   End
End
Attribute VB_Name = "frmCP_PO_Return_Reg"
...
Private Function PrintTrans() As Boolean
   ...
   lrs.Fields.Append "sField01", adVarChar, 30
   ...
   lrs.Fields.Append "sField07", adVarChar, 30
   lrs.Fields.Append "sField08", adVarChar, 30
   lrs.Open
