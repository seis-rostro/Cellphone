...
Begin VB.Form frmMade 
   BorderStyle     =   0  'None
   Caption         =   "Made  Maintenance"
   ClientHeight    =   2925
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4575
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmMade.frx":2CDC
      PicturePos      =   1
   End
End
Attribute VB_Name = "frmMade"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Private Const pxeMODULENAME = "frmMade"
...
Private Sub oDriver_InitValue()
   ...
   If oDriver.SetValue(0, GetNextCode("Made", "sMadeIDxx", False, oApp.Connection, False, "")) = False Then Exit Sub
