...
Option Explicit
Private Const pxeMODULENAME = "frmBrand"
...
Private Sub oDriver_InitValue()
   ...
   If oDriver.SetValue(0, GetNextCode("CP_Brand", "sBrandIDx", False, oApp.Connection, True, oApp.BranchCode)) = False Then Exit Sub
   oDriver.FieldReference(0) = True
   oDriver.FieldValue(3) = 1
