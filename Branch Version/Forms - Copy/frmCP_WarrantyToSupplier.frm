...
Begin VB.Form frmCP_WarratyToSupplier 
   BorderStyle     =   0  'None
   Caption         =   "Warranty To Supplier"
   ClientHeight    =   6900
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   11715
   ...
   Begin xrGridEditor.GridEditor GridEditor1 
      ...
      GRIDLINESFIXED  =   2
      GRIDLINEWIDTH   =   1
      MOUSEICON       =   "frmCP_WarrantyToSupplier.frx":0000
      MOUSEPOINTER    =   0
      REDRAW          =   -1  'True
      RIGHTTOLEFT     =   0   'False
      ROWS            =   2
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_WarrantyToSupplier.frx":001C
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   0
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_WarrantyToSupplier.frx":0796
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   1
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_WarrantyToSupplier.frx":0F10
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   3
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_WarrantyToSupplier.frx":168A
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   4
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_WarrantyToSupplier.frx":1E04
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   6
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_WarrantyToSupplier.frx":257E
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   5
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCP_WarrantyToSupplier.frx":2CF8
   End
   Begin xrControl.xrFrame xrFrame1 
      ...
      Begin VB.TextBox txtField 
         ...
         MultiLine       =   -1  'True
         TabIndex        =   11
         Text            =   "frmCP_WarrantyToSupplier.frx":3472
         Top             =   1575
         Width           =   8520
      End
      Begin VB.TextBox txtField 
      ...
      Begin VB.TextBox txtField 
         ...
         MultiLine       =   -1  'True
         TabIndex        =   5
         Text            =   "frmCP_WarrantyToSupplier.frx":347A
         Top             =   1095
         Width           =   4545
      End
      Begin VB.TextBox txtField 
   ...
   End
End
Attribute VB_Name = "frmCP_WarratyToSupplier"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Private Const pxeMODULENAME = "frmCP_WarrantyToSupplier"

Private WithEvents oTrans As clsCPWarranty
   ...
   With GridEditor1
      ...
      Case 0
         If .Rows > 2 Then
            ...
            .ColWidth(3) = 2600
            If .Rows > 16 Then .ColWidth(3) = 2400
         End If
      ...
      If oTrans.Detail(.Row - 1, "cHsSerial") = xeYes Then
         ...
         Case 1, 2
            If .TextMatrix(.Row, .Col) <> "" Then
               ...
               .TextMatrix(.Row, 7) = oTrans.Detail(.Row - 1, "nQuantity")
               If .Row = .Rows - 1 Then
                  .Rows = .Rows + 1
                  oTrans.AddDetail
                  .Col = 0
