...
Begin VB.Form frmLoad_Acceptance 
   BorderStyle     =   0  'None
   Caption         =   "Load Wallet Acceptance"
   ClientHeight    =   4125
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   7500
   ...
   Begin xrControl.xrFrame xrFrame1 
      ...
      Begin VB.TextBox txtfield 
         ...
         TabIndex        =   13
         Tag             =   "ht0;ft0"
         Text            =   "frmLoad_Acceptance.frx":0000
         Top             =   990
         Width           =   1575
      End
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmLoad_Acceptance.frx":0006
      CaptionAlign    =   0
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   405
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmLoad_Acceptance.frx":0780
      CaptionAlign    =   0
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   405
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmLoad_Acceptance.frx":0EFA
      CaptionAlign    =   0
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   405
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmLoad_Acceptance.frx":1674
      CaptionAlign    =   0
   End
   Begin xrControl.xrButton cmdButton 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmLoad_Acceptance.frx":1DEE
      CaptionAlign    =   0
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   405
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmLoad_Acceptance.frx":2568
      CaptionAlign    =   0
      BackColor       =   14286077
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmLoad_Acceptance.frx":2CE2
      CaptionAlign    =   0
      BackColor       =   14286077
      BackColorDown   =   8775418
      BorderColorFocus=   8775418
   ...
   End
End
Attribute VB_Name = "frmLoad_Acceptance"
...
Dim lsRep As Integer
   ...
   Select Case Index
   Case 0
'      For lnctr = 0 To oDriver.FieldCount - 1
'         MsgBox oDriver.FieldValue(lnctr) & " " & oDriver.FieldName(lnctr)
'      Next
      oDriver.RecordSave
   Case 1
...
Private Sub oDriver_InitValue()
   ...
   oDriver.FieldValue(6) = ""
   oDriver.FieldValue(7) = "CPDl"
...
Dim lnEntry As Integer
   ...
   Else
      ...
      lnEntry = getEntryNo("ELoad_Ledger", "'" & oDriver.FieldValue(6) & "'", _
                  "'" & oApp.BranchCode & "'")
      oDriver.FieldValue(8) = txtfield(8).Text
...
Function Transaction_No() As String
   ...
   lsSQL = "SELECT TOP 1" & _
            " sSourceNo" & _
            " FROM ELoad_Ledger " & _
            " WHERE sSourceNo LIKE " & strParm(oApp.BranchCode & "LA-%") & _
            " ORDER BY sSOurceNo DESC"
   ...
   If lrs.EOF Then
      lnCtr = 1
   Else
      If Left(lrs("sSourceNo"), 2) = oApp.BranchCode Then
         lnCtr = CLng(Right(lrs("sSourceNo"), 8)) + 1
      Else
         lnCtr = 1
      End If
   End If
   
   Transaction_No = oApp.BranchCode & "LA-" & Format(Date, "yy") & Format(lnCtr, "00000000")
   Set lrs = Nothing
End Function
...
Private Sub txtfield_Validate(Index As Integer, Cancel As Boolean)
   Select Case Index
      ...
      Case 3, 5
         ...
         ElseIf txtfield(Index).Text = 0# Then
...
Dim lsSearch As String
   ...
   lsSQL = "SELECT" _
      ...
      & " WHERE a.sBarrcode like  '" & txtothers(0).Text & "%' " _
         & " AND (cWalletxx = 1 or ccellload = 1) " _
      ...
      If oRS.RecordCount <> 0 Then
         ...
         Do While Not oRS.EOF
            lsSQL = "UPDATE CP_Inventory_Master SET" _
                  & " nQtyOnHnd = nQtyOnHnd - '" & CDbl(oRS("nQtyInxxx")) & "' " _
