      ...
      Case 8 'Print
         ...
         If GenerateReport Then
            ...
            If MsgBox("Do you want to eMail Purchase Order?", vbQuestion + vbYesNo, "") = vbYes Then
                ...
                Else
                  'she 2025-04-21
                  'temporary disable the auto email version for appliances PO(M001). the email add for appliances was not yet configured
                     If Not oApp.BranchCode = "M001" Or oApp.BranchCode = "M0W1" Then
                        If Not EmailPO Then
                           MsgBox "Unable to Upload purchase order.", vbCritical, "Warning"
                        End If
                     End If
